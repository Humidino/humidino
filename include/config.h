...
// ============================================================================
// Шина I2C 1: улица + третья зона подпола (Wire1)
// ============================================================================
...
// ============================================================================
// Идентификаторы датчиков — подпол разделён перегородками на три зоны
// (Приточка/Середина/Дальний угол), плюс один датчик улицы.
// ============================================================================
enum class SensorId : uint8_t {
    CrawlspaceIntake = 0,  // шина0, адрес 0x44 — Зона 1: Приточка подпола
    CrawlspaceMiddle = 1,  // шина1, адрес 0x45 — Зона 2: Середина подпола
    CrawlspaceCorner = 2,  // шина0, адрес 0x45 — Зона 3: Дальний угол подпола
    Outside          = 3,  // шина1, адрес 0x44 — Улица
    Count            = 4
};
